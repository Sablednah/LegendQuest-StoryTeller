 ...
 * {@code sendSystemMessage} on {@code LocalPlayer}; 26.x has the reverse, plus
 * {@code sendOverlayMessage} for the action bar. So the call lives here, once,
 * and a version drop edits this file rather than hunting call sites.
